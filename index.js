...
} = require("./assignment/products/index");

const { findOrCreateCustomer } = require("./assignment/customer/index");

const { createDraftInvoice } = require("./assignment/invoice/index");
